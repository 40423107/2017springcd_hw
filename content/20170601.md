...
請以 W15 練習為網誌標題, 800x600 為畫布大小, 在畫布正中央畫一個半徑為 250 畫素, 壓力角 20, 齒數為 36 齒, 且只有上半齒形的漸開線正齒輪輪廓. 
...
##利用漸開線原理, 以 Brython 繪製單一正齒輪廓:36齒
...
ctx.font = "25px DFKai-sb"
ctx.fillText("40423107 ",340,320)
ctx.stroke()
...
#輸入學號
ctx.fillText("40423106 ",canvas.width*0.05+rp_g1-(rp_g1)/2, canvas.height*0.1+rp_g1)
ctx.stroke()
...
ctx.font = "15px DFKai-sb"
#輸入學號
ctx.fillText("40423107 ",x_g1 + rp_g1 + rp_g2-(rp_g2)/2,y_g1)
ctx.stroke()
...
ctx.font = "15px DFKai-sb"
#輸入學號
ctx.fillText("40423108 ",x_g1 + rp_g1 + 2*rp_g2 + rp_g3-(rp_g3)/2,y_g1)
ctx.stroke()
...
ctx.font = "15px DFKai-sb"
#輸入學號
ctx.fillText("40423121 ", x_g1 + rp_g1 + 2*rp_g2 + 2*rp_g3+rp_g4-(rp_g4)/2,y_g1)
ctx.stroke()
...
ctx.font = "15px DFKai-sb"
#輸入學號
ctx.fillText("40423125 ",x_g1 + rp_g1 + 2*rp_g2 + 2*rp_g3+rp_g4-(rp_g4)/2, y_g4+rp_g4+rp_g5)
ctx.stroke()
...
ctx.font = "15px DFKai-sb"
#輸入學號
ctx.fillText("40423139 ",x_g1 + rp_g1 + 2*rp_g2 + 2*rp_g3+rp_g4-(rp_g4)/2,y_g4+rp_g4+2*rp_g5+rp_g6)
ctx.stroke()
...
ctx.font = "15px DFKai-sb"
#輸入學號
ctx.fillText("40423140 ",x_g1 + rp_g1 + 2*rp_g2 + 2*rp_g3+rp_g4-rp_g6-rp_g7-rp_g7/3,y_g4 +rp_g4+2*rp_g5+rp_g6)
ctx.stroke()
</script>
